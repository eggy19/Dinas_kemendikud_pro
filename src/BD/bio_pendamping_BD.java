 ...
 */
public class bio_pendamping_BD extends javax.swing.JFrame {
     ...
     */
    public bio_pendamping_BD() {
        super("Data Pendamping Debat Bahasa - Register Lomba");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(bio_pendamping_BD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new bio_pendamping_BD().setVisible(true);
            }
        });
    }
