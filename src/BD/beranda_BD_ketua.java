 ...
 */
public class beranda_BD_ketua extends javax.swing.JFrame {
    ...
    public beranda_BD_ketua() {
        super("DATA KETUA KONTINGEN - DEBAT BAHASA - Registrasi Lomba 1.0.0");
        initComponents();
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        bio_ket_kontingen_BD ketua = new bio_ket_kontingen_BD();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(beranda_BD_ketua.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new beranda_BD_ketua().setVisible(true);
            }
        });
    }
