 ...
 */
public class beranda_BD_peserta extends javax.swing.JFrame {
    ...
    public beranda_BD_peserta() {
        super("DATA PESERTA - DEBAT BAHASA -Registrasi Lomba 1.0.0");
        initComponents();
        setLocation(40, 80);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        new bio_peserta_BD().show();
        this.hide();
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        // TODO add your handling code here:
        bio_peserta_BD peserta = new bio_peserta_BD();
    ...
    private void btn_editActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_editActionPerformed
        bio_peserta_BD juri = new bio_peserta_BD();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(beranda_BD_peserta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new beranda_BD_peserta().setVisible(true);
            }
        });
    }
    ...
    private void masuk_ke_table(){
            ...
            int i = 1;
            res= stat.executeQuery("SELECT * FROM tb_peserta WHERE katagori='debat bahasa'");
            while (res.next()) {
