 ...
 */
public class beranda_FLS2N_peserta extends javax.swing.JFrame {
    ...
    public beranda_FLS2N_peserta() {
        super("DATA PESERTA - FLS2N -Registrasi Lomba 1.0.0");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        new bio_peserta_FLS2N().show();
        this.hide();
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        // TODO add your handling code here:
        bio_peserta_FLS2N peserta = new bio_peserta_FLS2N();
    ...
    private void btn_editActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_editActionPerformed
        bio_peserta_FLS2N juri = new bio_peserta_FLS2N();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(beranda_FLS2N_peserta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new beranda_FLS2N_peserta().setVisible(true);
            }
        });
    }
    ...
    private void masuk_ke_table(){
            ...
            int i = 1;
            res= stat.executeQuery("SELECT * FROM tb_peserta WHERE katagori='FLS2N'");
            while (res.next()) {
