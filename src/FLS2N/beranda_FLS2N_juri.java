 ...
 */
public class beranda_FLS2N_juri extends javax.swing.JFrame {
    ...
    public beranda_FLS2N_juri() {
        super("DATA JURI - FLS2N - Registrasi Lomba 1.0.0");
        initComponents();
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        bio_juri_FLS2N juri = new bio_juri_FLS2N();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(beranda_FLS2N_juri.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        } catch (InstantiationException ex) {
            java.util.logging.Logger.getLogger(beranda_FLS2N_juri.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        } catch (IllegalAccessException ex) {
            java.util.logging.Logger.getLogger(beranda_FLS2N_juri.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        } catch (javax.swing.UnsupportedLookAndFeelException ex) {
            java.util.logging.Logger.getLogger(beranda_FLS2N_juri
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new beranda_FLS2N_juri().setVisible(true);
            }
        });
    }
    ...
    private void masuk_ke_table(){        
            ...
            res= stat.executeQuery("SELECT * FROM tb_juri WHERE katagori='FLS2N'");
            while (res.next()) {
