 ...
 */
public class bio_peserta_FLS2N extends javax.swing.JFrame {
     ...
     */
    public bio_peserta_FLS2N() {
        super("Data Peserta FLS2N - Register Lomba");        
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(bio_peserta_FLS2N.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new bio_peserta_FLS2N().setVisible(true);
            }
        });
    }
