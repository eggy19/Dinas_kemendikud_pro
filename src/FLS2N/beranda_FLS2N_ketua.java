 ...
 */
public class beranda_FLS2N_ketua extends javax.swing.JFrame {
    ...
    public beranda_FLS2N_ketua() {
        super("DATA KETUA KONTINGEN - FLS2N - Registrasi Lomba 1.0.0");
        initComponents();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        new bio_ket_kontingen_FLS2N().show();
        this.hide();
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        bio_ket_kontingen_FLS2N ketua = new bio_ket_kontingen_FLS2N();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(beranda_FLS2N_ketua.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new beranda_FLS2N_ketua().setVisible(true);
            }
        });
    }
    ...
    private void masuk_ke_table(){
            ...
            res= stat.executeQuery("SELECT * FROM tb_ketua_kontingen WHERE katagori='FLS2N'");
            while (res.next()) {
