 ...
 */
public class bio_juri_FLS2N extends javax.swing.JFrame {
     ...
     */
    public bio_juri_FLS2N() {
        super("Data Juri FLS2N - Register Lomba");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(bio_juri_FLS2N.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new bio_juri_FLS2N().setVisible(true);
            }
        });
    }
