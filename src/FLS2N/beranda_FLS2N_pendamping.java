 ...
 */
public class beranda_FLS2N_pendamping extends javax.swing.JFrame {
    ...
    public beranda_FLS2N_pendamping() {
        super("DATA PENDAMPING - FLS2N - Registrasi Lomba 1.0.0");
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(new java.awt.Color(153, 153, 153), null), "Data OSTN", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 1, 15))); // NOI18N
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        new beranda_FLS2N_juri().show();
        this.hide();
    }//GEN-LAST:event_jButton6ActionPerformed

    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        new bio_pendamping_FLS2N().show();
        this.hide();
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        bio_pendamping_FLS2N damping = new bio_pendamping_FLS2N();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(beranda_FLS2N_pendamping.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new beranda_FLS2N_pendamping().setVisible(true);
            }
        });
    }
    ...
    private void masuk_ke_table(){
            ...
            res = stat.executeQuery("SELECT * FROM tb_pendamping WHERE katagori='FLS2N'");
            while (res.next()) {
...
private void cari_data(){
        try {
            ...
            JOptionPane.showMessageDialog(null, "Table Eror : " + e);
        }
