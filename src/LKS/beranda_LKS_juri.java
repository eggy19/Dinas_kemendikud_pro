 ...
 */
public class beranda_LKS_juri extends javax.swing.JFrame {
    ...
    public beranda_LKS_juri() {
        super("DATA JURI - LKS - Registrasi Lomba 1.0.0");
        initComponents();
        setLocation(40, 80);
        masuk_ke_table();
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        bio_juri_LKS juri = new bio_juri_LKS();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(beranda_LKS_juri.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        } catch (InstantiationException ex) {
            java.util.logging.Logger.getLogger(beranda_LKS_juri.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        } catch (IllegalAccessException ex) {
            java.util.logging.Logger.getLogger(beranda_LKS_juri.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        } catch (javax.swing.UnsupportedLookAndFeelException ex) {
            java.util.logging.Logger.getLogger(beranda_LKS_juri
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new beranda_LKS_juri().setVisible(true);
            }
        });
    }
    ...
    private void masuk_ke_table(){        
            ...
            res= stat.executeQuery("SELECT * FROM tb_juri WHERE katagori='lks'");
            while (res.next()) {
