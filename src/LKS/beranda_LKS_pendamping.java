 ...
 */
public class beranda_LKS_pendamping extends javax.swing.JFrame {
    ...
    public beranda_LKS_pendamping() {
        super("DATA PENDAMPING - LKS - Registrasi Lomba 1.0.0");
        initComponents();
        setLocation(40, 80);
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        bio_pendamping_LKS damping = new bio_pendamping_LKS();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(beranda_LKS_pendamping.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new beranda_LKS_pendamping().setVisible(true);
            }
        });
    }
    ...
    private void masuk_ke_table(){
            ...
            res= stat.executeQuery("SELECT * FROM tb_pendamping WHERE katagori='lks'");
            while (res.next()) {
