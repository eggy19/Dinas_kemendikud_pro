 ...
 */
public class bio_ket_kontingen_LKS extends javax.swing.JFrame {
     ...
     */
    public bio_ket_kontingen_LKS() {
        super("Data Ketua Kontingen LKS - Register Lomba");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(bio_ket_kontingen_LKS.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new bio_ket_kontingen_LKS().setVisible(true);
            }
        });
    }
