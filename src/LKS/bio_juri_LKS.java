 ...
 */
public class bio_juri_LKS extends javax.swing.JFrame {
     ...
     */
    public bio_juri_LKS() {
        super("Data Juri LKS - Register Lomba");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(bio_juri_LKS.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new bio_juri_LKS().setVisible(true);
            }
        });
    }
    ...
    private void pilih_lomba(){
        ...
        try {
            String sql = "SELECT * FROM lomba_lks";
