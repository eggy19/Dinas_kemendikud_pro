 ...
 */
public class bio_peserta_LKS extends javax.swing.JFrame {
     ...
     */
    public bio_peserta_LKS() {
        super("Data Peserta LKS - Register Lomba");        
        initComponents();
        pilih_lomba();
        pilih_agama();
        kosong();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(bio_peserta_LKS.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new bio_peserta_LKS().setVisible(true);
            }
        });
    }
    ...
    private void pilih_lomba(){
        Statement pilih_lomba;
        try {            
            String sql = "SELECT * FROM lomba_lks";
            pilih_lomba = con.createStatement();
            res = pilih_lomba.executeQuery(sql);
            while(res.next()){
