 ...
 */
public class bio_ket_kontingen_OSTN extends javax.swing.JFrame {
     ...
     */
    public bio_ket_kontingen_OSTN() {
        super("Data Ketua Kontingen OSTN - Register Lomba");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(bio_ket_kontingen_OSTN.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new bio_ket_kontingen_OSTN().setVisible(true);
            }
        });
    }
