 ...
 */
public class beranda_OSTN_peserta extends javax.swing.JFrame {
    ...
    public beranda_OSTN_peserta() {
        super("DATA PESERTA - OSTN -Registrasi Lomba 1.0.0");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        new beranda_OSTN_ketua().show();
        this.hide();
    }//GEN-LAST:event_jButton3ActionPerformed

    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        new beranda_OSTN_juri().show();
        this.hide();
    }//GEN-LAST:event_jButton6ActionPerformed

    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        new beranda_OSTN_pendamping().show();
        this.hide();
    }//GEN-LAST:event_jButton5ActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed

        new bio_peserta_OSTN().show();
        this.hide();
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        // TODO add your handling code here:
        bio_peserta_OSTN peserta = new bio_peserta_OSTN();
    ...
    private void btn_editActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_editActionPerformed
        bio_peserta_OSTN juri = new bio_peserta_OSTN();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(beranda_OSTN_peserta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new beranda_OSTN_peserta().setVisible(true);
            }
        });
    }
    ...
    private void masuk_ke_table(){
            ...
            int i = 1;
            res= stat.executeQuery("SELECT * FROM tb_peserta WHERE katagori='OSTN'");
            while (res.next()) {
