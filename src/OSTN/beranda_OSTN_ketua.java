 ...
 */
public class beranda_OSTN_ketua extends javax.swing.JFrame {
    ...
    public beranda_OSTN_ketua() {
        super("DATA KETUA KONTINGEN - OSTN - Registrasi Lomba 1.0.0");
        initComponents();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        new bio_ket_kontingen_OSTN().show();
        this.hide();
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        bio_ket_kontingen_OSTN ketua = new bio_ket_kontingen_OSTN();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(beranda_OSTN_ketua.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new beranda_OSTN_ketua().setVisible(true);
            }
        });
    }
    ...
    private void masuk_ke_table(){
            ...
            res= stat.executeQuery("SELECT * FROM tb_ketua_kontingen WHERE katagori='OSTN'");
            while (res.next()) {
