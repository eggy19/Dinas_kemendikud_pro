 ...
 */
public class beranda_OSTN_juri extends javax.swing.JFrame {
    ...
    public beranda_OSTN_juri() {
        super("DATA JURI - OSTN - Registrasi Lomba 1.0.0");
        initComponents();
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        bio_juri_OSTN juri = new bio_juri_OSTN();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(beranda_OSTN_juri.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        } catch (InstantiationException ex) {
            java.util.logging.Logger.getLogger(beranda_OSTN_juri.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        } catch (IllegalAccessException ex) {
            java.util.logging.Logger.getLogger(beranda_OSTN_juri.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        } catch (javax.swing.UnsupportedLookAndFeelException ex) {
            java.util.logging.Logger.getLogger(beranda_OSTN_juri
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new beranda_OSTN_juri().setVisible(true);
            }
        });
    }
    ...
    private void masuk_ke_table(){        
            ...
            res= stat.executeQuery("SELECT * FROM tb_juri WHERE katagori='OSTN'");
            while (res.next()) {
