 ...
 */
public class beranda_OSTN_pendamping extends javax.swing.JFrame {
    ...
    public beranda_OSTN_pendamping() {
        super("DATA PENDAMPING - OSTN - Registrasi Lomba 1.0.0");
        initComponents();
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        bio_pendamping_OSTN damping = new bio_pendamping_OSTN();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(beranda_OSTN_pendamping.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new beranda_OSTN_pendamping().setVisible(true);
            }
        });
    }
    ...
    private void masuk_ke_table(){
            ...
            stat.executeQuery("SELECT * FROM tb_pendamping WHERE katagori='OSTN'");
            while (res.next()) {
